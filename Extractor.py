...
if(len(sys.argv) < 2 or sys.argv[1] == "-h"):
    print("usage: python3 DecompNewDell.py <biosupdate.exe>")
    exit()
...
pat = re.compile(b'.{4}\xAA\xEE\xAA\x76\x1B\xEC\xBB\x20\xF1\xE6\x51.{1}\x78\x9C')
...
f.close()
f2.close()
print("Decompressed data written to " +  sys.argv[1] + "_decompressed.hdr")
